...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary border-t border-slate-700 py-12">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="text-slate-300 mb-6 max-w-md">
              India's first optimization engine powered by AI + Quantum algorithms. Revolutionizing last-mile logistics and business operations.
            </p>
          ...
          >
            ...
            <ul className="space-y-2 text-slate-300">
              ...
              <li><a href="#" className="hover:text-secondary transition-colors">Investors</a></li>
              <li>
                <button 
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <p>&copy; 2025 ENGN-F1. All rights reserved. | India's First Optimization Engine</p>
        </motion.div>
      </div>
    </footer>
  );
